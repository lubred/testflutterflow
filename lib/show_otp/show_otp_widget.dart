...
class ShowOtpWidget extends StatefulWidget {
  const ShowOtpWidget({
    super.key,
    required this.pTokenName,
    required this.pAccountNo,
    required this.pSerialNo,
    required this.pAuthorisationCode,
  });

  final String? pTokenName;
  final String? pAccountNo;
  final String? pSerialNo;
  final String? pAuthorisationCode;

  static String routeName = 'showOtp';
  static String routePath = '/showOtp';

  @override
  State<ShowOtpWidget> createState() => _ShowOtpWidgetState();
}

class _ShowOtpWidgetState extends State<ShowOtpWidget> {
  late ShowOtpModel _model;
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 10.0, 0.0, 0.0),
                          child: Text(
                            '${_model.timeremaining} secs left',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
